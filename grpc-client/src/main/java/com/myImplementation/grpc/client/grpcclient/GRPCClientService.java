...
public class GRPCClientService {
	...
	public String matrixMultiplicationOperation(String mA, String mB, int dimentions, int deadline, int serverIndex) {
		...
		System.out.println("\n<======Mult======>\n[Estimated Time (One Server)]: " + String.valueOf((int) Math.ceil(((double) footprint * ((double) blockDim * ((double) blockDim * (double) blockDim))) / (double) ((double) (deadline * 1000000000.0)))) + " Seconds (" + String.valueOf((int) Math.ceil(((double) footprint * ((double) blockDim * ((double) blockDim * (double) blockDim))) / (double) ((double) (deadline * 1000000000.0)))/60) + " Minutes, " + String.valueOf((int) Math.ceil(((double) footprint * ((double) blockDim * ((double) blockDim * (double) blockDim))) / (double) ((double) (deadline * 1000000000.0)))%60) + " Seconds)\n[FootPrint]: " + String.valueOf(footprintInSeconds) + "\n[Number Of Blocks To Multiply]: " + String.valueOf(blockDim * (blockDim * blockDim)) + "\n[Servers Needed To Meet Deadline]: " + serversNeeded + "\n");
		...
		System.out.println("[Servers Assigned]: " + serversNeeded + "\n[New Time Estimate]: " + String.valueOf((int) Math.ceil(((double) footprint * ((double) blockDim * ((double) blockDim * (double) blockDim))) / (double) (1000000000.0))/serversNeeded) + " Seconds (" + String.valueOf((int)(Math.ceil(((double) footprint * ((double) blockDim * ((double) blockDim * (double) blockDim))) / (double) (1000000000.0))/(double) serversNeeded)/60) + " Minutes, " + String.valueOf((int)(Math.ceil(((double) footprint * ((double) blockDim * ((double) blockDim * (double) blockDim))) / (double) (1000000000.0))/(double) serversNeeded)%60) + " Seconds)" + "\n<================>\n");
